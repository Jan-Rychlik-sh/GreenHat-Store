document.addEventListener("DOMContentLoaded", function () {
  ...
  document.querySelectorAll(".buy_button").forEach((el) => {
    el.addEventListener("click", function () {
      let number = parseInt(this.id);
      let product = document.getElementById(number + "product").textContent;
      let img_product_image = document
        .getElementById(number + "img_product_image")
        .cloneNode(true);
      let price = document.getElementById(number + "price").textContent;
      sum += parseInt(price);

      //Element usuwający z koszyka produkt
      ...
      remove_product.style.cursor = "pointer";

      // Tworzymy kontener dla pojedynczego produktu
      let OneProductContainer = document.createElement("div");
      OneProductContainer.classList.add("OneProductContainer");
      OneProductContainer.id = number + "OneProductContainer";

      // Tworzymy elementy dla nazwy, obrazka i ceny produktu
      let productName = document.createElement("div");
      productName.textContent = product;
      let productPrice = document.createElement("div");
      productPrice.textContent = "Cena: " + price;

      //Kontener dla prawej zawartości produktu
      let AddedProductDescription = document.createElement("div");
      AddedProductDescription.classList.add("AddedProductDescription");
      AddedProductDescription.appendChild(productName);
      AddedProductDescription.appendChild(productPrice);
      ...
      remove_product.addEventListener("click", function () {
        document
          .querySelector("#product_to_buy")
          .removeChild(document.getElementById(number + "OneProductContainer"));
      ...
      document
        .querySelector("#product_to_buy")
        .appendChild(OneProductContainer);
      document.querySelector("#sum").innerHTML = sum + "zł";
    });
  });
});
